...
import utils.LSTMClassifier_imgv2 as LSTMC
...
DATA_DIR = 'data'
TRAIN_DIR = 'train_txt_verb'
TEST_DIR = 'test_txt_verb'
TRAIN_FILE = 'train_txt_verb.txt'
TEST_FILE = 'test_txt_verb.txt'
TRAIN_LABEL = 'train_label_verb.txt'
TEST_LABEL = 'test_label_verb.txt'
TRAIN_IMG = 'train_img_verb'
TEST_IMG = 'test_img_verb'
