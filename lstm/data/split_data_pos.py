...
#DATA_DIR = 'newdata'
TRAIN_FILE = 'POSTraining.txt'
#TRAIN_FILE = 'mc_mscoco_train_posformat_sentencelabel.txt'
TEST_FILE = 'POSTesting.txt'
#TEST_FILE = 'mc_mscoco_test_posformat_sentencelabel.txt'
#TEST_FILE = 'pos_training_r8_style.txt'
TRAID_DIR = 'train_txt_pos'
...
if __name__=='__main__':
    ...
    fp_file = open('train_txt_pos.txt', 'w')
    for file in train_file:
       # print file
        fp_file.write(file + '\n')
    fp_file.close()
    fp_label = open('train_label_pos.txt', 'w')
    ...
    for lines in fp:
        ...
        try:
            ...
            import ipdb
            ipdb.set_trace()
    fp_file = open('test_txt_pos.txt', 'w')
    for file in test_file:
        fp_file.write(file + '\n')
    fp_file.close()

    fp_label = open('test_label_pos.txt', 'w')
    for t in test_label:
        fp_label.write(str(t) + '\n')
    fp_label.close()
