...
DATA_DIR = 'data'
TRAIN_DIR = 'train_txt_adv'
TEST_DIR = 'test_txt_adv'
TRAIN_FILE = 'train_txt_adv.txt'
TEST_FILE = 'test_txt_adv.txt'
TRAIN_LABEL = 'train_label_adv.txt'
TEST_LABEL = 'test_label_adv.txt'
TRAIN_IMG = 'train_img_adv'
TEST_IMG = 'test_img_adv'
