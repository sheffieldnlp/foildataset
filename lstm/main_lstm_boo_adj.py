...
DATA_DIR = 'data'
TRAIN_DIR = 'train_txt_adj'
TEST_DIR = 'test_txt_adj'
TRAIN_FILE = 'train_txt_adj.txt'
TEST_FILE = 'test_txt_adj.txt'
TRAIN_LABEL = 'train_label_adj.txt'
TEST_LABEL = 'test_label_adj.txt'
TRAIN_IMG = 'train_img_adj'
TEST_IMG = 'test_img_adj'
