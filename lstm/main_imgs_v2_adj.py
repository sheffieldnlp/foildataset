...
DATA_DIR = 'data'
TRAIN_DIR = 'train_txt_new'
TEST_DIR = 'test_txt_new'
TRAIN_FILE = 'train_txt_new.txt'
TEST_FILE = 'test_txt_new.txt'
TRAIN_LABEL = 'train_label_new.txt'
TEST_LABEL = 'test_label_new.txt'
TRAIN_IMG = 'train_img_new_boo'
TEST_IMG = 'test_img_new_boo'
