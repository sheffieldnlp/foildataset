...
DATA_DIR = 'data'
TRAIN_DIR = 'train_txt_pp'
TEST_DIR = 'test_txt_pp'
TRAIN_FILE = 'train_txt_pp.txt'
TEST_FILE = 'test_txt_pp.txt'
TRAIN_LABEL = 'train_label_pp.txt'
TEST_LABEL = 'test_label_pp.txt'
TRAIN_IMG = 'train_img_pp'
TEST_IMG = 'test_img_pp'
